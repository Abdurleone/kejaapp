...
- Mobile: test coverage still doesn't reach every screen (e.g. Dashboard, Discover, Movers, Notifications, Feedback, Account, Requests are still untested) — the modules added/changed across the last few passes now have coverage, but this isn't exhaustive.
