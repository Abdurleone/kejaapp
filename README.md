...
- **Render Blueprint via [render.yaml](render.yaml) — the actual live production deployment** (`jakezapp-backend.onrender.com` — one URL for both the web app and its API)
