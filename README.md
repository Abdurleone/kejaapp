...
- Mobile: expand test coverage beyond the initial API-client/formatter/component tests (screens, navigation, context providers) — the new `PropertyEditScreen`/`AdminScreen`/`propertyForm.js`/`roleTabs.js` modules added in this pass are untested too.
