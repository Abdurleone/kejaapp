...
- **Landlords and agencies** are solely responsible for the accuracy of the listings they publish — description, pricing, amenities, images, and contact details. KejaApp does not independently verify the physical existence, ownership, or condition of a listed property.
...
Use of KejaApp is also governed by the [Acceptable Use Policy](acceptable-use-policy.md), which covers prohibited content and conduct (fraud, discrimination, harassment, and similar). Violations are handled through KejaApp's trust-and-safety process described there and in the [Code of Ethics](code-of-ethics.md#3-enforcement), up to and including account suspension or ban.
...
KejaApp is provided **"as is"** and **"as available."** To the fullest extent permitted by Kenyan law:

- KejaApp does not warrant that listings are accurate, complete, or currently available, that a mover will perform as described, or that the platform will be uninterrupted or error-free.
...
To the fullest extent permitted by law, KejaApp's aggregate liability for any claim arising from your use of the platform is limited to the amount (if any) you paid to KejaApp in the twelve months before the claim arose. Since KejaApp does not charge users for access in its current scope, this limit is nil unless a paid feature is introduced and disclosed separately. KejaApp is not liable for indirect, incidental, or consequential loss, including loss of a tenancy, a moving arrangement, or income.
...
These terms are governed by the laws of the **Republic of Kenya**. Disputes between you and KejaApp are subject to the exclusive jurisdiction of the courts of Kenya, without prejudice to any mandatory consumer-protection venue rights you may have. Disputes **between users** (e.g. a tenant and a landlord, or a tenant and a mover) are not mediated or arbitrated by KejaApp — see the [Dispute Resolution & Complaints Policy](dispute-resolution-policy.md) for what support KejaApp does and doesn't offer there.

## 12. Changes to these terms

Material changes will be reflected here with an updated revision note. Continued use of KejaApp after a change is posted constitutes acceptance of the revised terms. Significant changes affecting your rights will also be communicated via an in-app notification where practical.

## 13. Contact

Questions about these terms: `privacy@kejaapp.com` (privacy/data matters) or the in-app Feedback tab (general questions).

## 14. Scope and limitations

This is operational documentation of the terms KejaApp intends to operate under, written to be genuinely useful to users and to the team building the platform. It is **not** a substitute for review by a qualified lawyer licensed in Kenya (or any other jurisdiction KejaApp operates in) before being relied on as a binding legal agreement in production.
