...
- **Send an inquiry** — a message plus an optional contact preference. The owner is notified and can respond; you'll see their response and your inquiry's status (open/responded/closed) in your own inquiry history **on mobile** (More → Requests → Inquiries). On web, only aggregate counts show on your Dashboard - there's no list of your own sent inquiries there yet.
