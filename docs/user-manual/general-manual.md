...
- **Support KejaApp** — an entirely optional way to send the app's developer a small M-Pesa payment, if you'd like to. This is not rent, a deposit, or any fee owed to another user — see [Payment Boundary](../../README.md#payment-boundary). Available to every signed-in role.
